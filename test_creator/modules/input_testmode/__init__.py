from test_creator.modules.input_testmode.classes import *
from test_creator.modules.input_testmode.round_creator import *
...
def setup(test_object_getter_func: Callable[[], classes.Test]):
    ...
    dpg.add_button(label=loc('input_testmode.__init__.add_round_button'), callback=lambda: open_round_creator())
